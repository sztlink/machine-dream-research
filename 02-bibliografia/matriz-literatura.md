...
|---|---:|---|
| BUZSÁKI, György. Hippocampal sharp wave-ripple: a cognitive biomarker for episodic memory and planning. *Hippocampus*, v. 25, n. 10, p. 1073–1188, 2015. DOI: [10.1002/hipo.22488](https://doi.org/10.1002/hipo.22488). | verificada | Base neurocientífica do replay offline/prospectivo: rastros recentes e informações pré-existentes podem ser combinados em estados offline para consolidar memória, influenciar decisões e planejar ações. |
| BARRY, Daniel N.; LOVE, Bradley C. A neural network account of memory replay and knowledge consolidation. *Cerebral Cortex*, v. 33, n. 1, p. 83–95, 2023. Publicado online em 2022. DOI: [10.1093/cercor/bhac054](https://doi.org/10.1093/cercor/bhac054). | verificada | Apoia a ponte entre replay, consolidação de conhecimento e modelos computacionais. Corrige a nota antiga “Barry & Love 2022”: a publicação online é 2022, mas a referência bibliográfica principal é 2023. |
| WAMSLEY, Erin J. Constructive episodic simulation in dreams. *PLOS ONE*, v. 17, n. 3, e0264574, 2022. DOI: [10.1371/journal.pone.0264574](https://doi.org/10.1371/journal.pone.0264574). | adicionada | Reforça o eixo “sonho não apenas reproduz passado”: sonhos podem recombinar fragmentos de memória para simular futuros possíveis. |

## 2. Núcleo verificado — agentes, contexto e memória computacional

| Referência | Status | Função no Machine Dream |
|---|---:|---|
| LIU, Nelson F. et al. Lost in the Middle: how language models use long contexts. *Transactions of the Association for Computational Linguistics*, v. 12, p. 157–173, 2024. DOI: [10.1162/tacl_a_00638](https://doi.org/10.1162/tacl_a_00638). Preprint: arXiv:2307.03172. | verificada | Justifica arquitetura com checkpoints, síntese e seleção: contexto longo não equivale a boa recuperação. Corrige a nota antiga “Lost-in-Middle 2024” com DOI e venue. |
| PACKER, Charles et al. MemGPT: towards LLMs as operating systems. arXiv:2310.08560, 2023. Disponível em: [https://arxiv.org/abs/2310.08560](https://arxiv.org/abs/2310.08560). | verificada como preprint | Apoia a noção de memória virtual e gerenciamento de contexto em agentes persistentes. Usar como referência técnica, não como fundamento artístico. |
| CHEUNG, Valen. Dreaming Is Not a Bug: a Jung-inspired dream layer for multi-agent LLM companions. arXiv:2601.06115, 2026. Disponível em: [https://arxiv.org/abs/2601.06115](https://arxiv.org/abs/2601.06115). | verificada como preprint | Importante como contraste contemporâneo: “dream layer” em agentes LLM, Jung e alucinação controlada. Não é origem do Machine Dream; entra como interlocutor posterior. |

## 3. Núcleo verificado — psicanálise do sonho e elaboração
...
| Item | Motivo | Ação |
|---|---|---|
| “MindBot Ultra” | Não apareceu como publicação acadêmica revisada; fonte principal é Hugging Face/blog/white paper. | Manter fora da bibliografia principal. Pode aparecer em nota de campo sobre imaginário técnico de “dreaming agents”, se necessário. |
